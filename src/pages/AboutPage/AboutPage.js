      ...
      <div className="Wrapper">
        <div className="RightContent">
          <p>
            ...
            engineering and my summers gaining hands-on experience to further develop my technical skills. As a highly empathetic individual, I have always strived to understand an experience from the
            end user’s perspective. My love for <span className="highlight">JavaScript</span> and everything web, combined with my curiosity inspires me to explore new ways to{' '}
          ...
          <p>
            ...
            which led me to discover my passion for <span className="highlight">solving problems at the intersection of business and technology</span>. Having a love for learning, I decided to pursue
            a dual degree in business and engineering at <a href={'https://www.ivey.uwo.ca'}> Ivey Business School</a>,<a href={'https://www.uwo.ca'}> Western University. </a>
          </p>
          <p>
